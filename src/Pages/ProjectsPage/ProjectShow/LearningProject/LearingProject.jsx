...
const ProfessionalProject = () => {
  const { my_project_func, collegeProject } = useContext(DataContext);
  ...
  return (
    <div className="p-4 shadow bg-image-container">
      ...
      {/* Project Cards */}
      {collegeProject?.map((project) => (
        <div
          key={project.id}
          className="mb-4 p-2 border border-gray-300 text-center bg-gray-100 shadow-2xl rounded-xl "
        >
          <h2 className="text-xs font-bold mb-2 text-center text-gray-900 underline">
            {project.title}
          </h2>
